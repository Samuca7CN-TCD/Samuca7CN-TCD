import {
  ...
  ee,
  k
} from "./chunk-4C7E7BSF.js";
import "./chunk-WZ76Y7S7.js";
import "./chunk-5ZI2DHBI.js";
import {
  computed,
  createSSRApp,
  defineComponent,
...
function T(e, o) {
  let n = typeof e == "string" ? e : null, p = typeof e == "string" ? o : e, t = n ? Oe.restore(n) : null, a = typeof p == "object" ? (0, import_lodash2.default)(p) : (0, import_lodash2.default)(p()), l = null, f = null, h2 = (r) => r, y = reactive({ ...t ? t.data : (0, import_lodash2.default)(a), isDirty: false, errors: t ? t.errors : {}, hasErrors: false, processing: false, progress: null, wasSuccessful: false, recentlySuccessful: false, data() {
    ...
    let c = h2(this.data()), b = { ...i, onCancelToken: (u) => {
      if (l = u, i.onCancelToken)
        return i.onCancelToken(u);
    }, onBefore: (u) => {
      ...
      if (this.progress = u, i.onProgress)
        return i.onProgress(u);
    }, onSuccess: async (u) => {
      ...
      let R = i.onSuccess ? await i.onSuccess(u) : null;
      return a = (0, import_lodash2.default)(this.data()), this.isDirty = false, R;
    }, onError: (u) => {
      if (this.processing = false, this.progress = null, this.clearErrors().setError(u), i.onError)
        return i.onError(u);
    }, onCancel: () => {
...
var S = ref(null);
var A = null;
var W = defineComponent({ name: "Inertia", props: { initialPage: { type: Object, required: true }, initialComponent: { type: Object, required: false }, resolveComponent: { type: Function, required: false }, titleCallback: { type: Function, required: false, default: (e) => e }, onHeadUpdate: { type: Function, required: false, default: () => () => {
} } }, setup({ initialPage: e, initialComponent: o, resolveComponent: n, titleCallback: p, onHeadUpdate: t }) {
  m.value = o ? markRaw(o) : null, d.value = e, S.value = null;
  let a = typeof window > "u";
  return A = Q(a, p, t), a || (Oe.init({ initialPage: e, resolveComponent: n, swapComponent: async (l) => {
    m.value = markRaw(l.component), d.value = l.page, S.value = l.preserveState ? S.value : Date.now();
  } }), Oe.on("navigate", () => A.forceUpdate())), () => {
    if (m.value) {
      m.value.inheritAttrs = !!m.value.inheritAttrs;
      let l = h(m.value, { ...d.value.props, key: S.value });
      return k2.value && (m.value.layout = k2.value, k2.value = null), m.value.layout ? typeof m.value.layout == "function" ? m.value.layout(h, l) : (Array.isArray(m.value.layout) ? m.value.layout : [m.value.layout]).concat(l).reverse().reduce((f, h2) => (h2.inheritAttrs = !!h2.inheritAttrs, h(h2, { ...d.value.props }, () => f))) : l;
    }
  };
} });
var I = W;
var $ = { install(e) {
  Oe.form = T, Object.defineProperty(e.config.globalProperties, "$inertia", { get: () => Oe }), Object.defineProperty(e.config.globalProperties, "$page", { get: () => d.value }), Object.defineProperty(e.config.globalProperties, "$headManager", { get: () => A }), e.mixin(w);
} };
function K() {
...
async function j({ id: e = "app", resolve: o, setup: n, title: p, progress: t = {}, page: a, render: l }) {
  let f = typeof window > "u", h2 = f ? null : document.getElementById(e), y = a || JSON.parse(h2.dataset.page), r = (c) => Promise.resolve(o(c)).then((b) => b.default || b), s = [], i = await r(y.component).then((c) => n({ el: h2, App: I, props: { initialPage: y, initialComponent: c, resolveComponent: r, titleCallback: p, onHeadUpdate: f ? (b) => s = b : null }, plugin: $ }));
  if (!f && t && Z(t), f) {
    let c = await l(createSSRApp({ render: () => h("div", { id: e, "data-page": JSON.stringify(y), innerHTML: i ? l(i) : "" }) }));
    return { head: s, body: c };
  }
}
var X = defineComponent({ props: { title: { type: String, required: false } }, data() {
...
<Link href="${a}" method="${t}" as="button">...</Link>`), h(e.as, { ...n, ...p === "a" ? { href: a } : {}, onClick: (f) => {
      ee(f) && (f.preventDefault(), Oe.visit(a, { data: l, method: t, replace: e.replace, preserveScroll: e.preserveScroll, preserveState: e.preserveState ?? t !== "get", only: e.only, headers: e.headers, onCancelToken: n.onCancelToken || (() => ({})), onBefore: n.onBefore || (() => ({})), onStart: n.onStart || (() => ({})), onProgress: n.onProgress || (() => ({})), onFinish: n.onFinish || (() => ({})), onCancel: n.onCancel || (() => ({})), onSuccess: n.onSuccess || (() => ({})), onError: n.onError || (() => ({})) }));
    } }, o);
  };
} });
var ie = se;
